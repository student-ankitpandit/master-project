...
const generateAccessandRefeshToken = async(userId) => {
    try {
        ...
        await user.save({validateBeforeSave: false}) //because of kickin
...
const registerUser = asyncHandler( async(req, res) => {
    ...
    //upload then on cloudinary, special check for avatar
...
const loginUser = asyncHandler( async(req, res) => {
    ...
    .json(
        new ApiResponse(
            200, 
            {
                user: loggedInUser, accessToken, refreshToken //when user is saving the token through itself
            },
...
const changeCurrentPassword = asyncHandler(async(req, res) => {
    ...
    user.password = newPassword //setting new password to this user object
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    if(!coverImageLocalPath) {
        throw new ApiResponse(400, "CoverImage is missing")
    }
